 ...
 * Original file: D:\\NewExamples\\Open-Battery-Saver-master\\Source code\\Android Application\\OpenBatterySaver\\src\\vn\\cybersoft\\obs\\andriod\\batterystats2\\PowerNotifications.aidl
 */
package vn.cybersoft.obs.andriod.batterystats2;
public interface PowerNotifications extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements vn.cybersoft.obs.andriod.batterystats2.PowerNotifications
{
private static final java.lang.String DESCRIPTOR = "vn.cybersoft.obs.andriod.batterystats2.PowerNotifications";
...
/**
 * Cast an IBinder object into an vn.cybersoft.obs.andriod.batterystats2.PowerNotifications interface,
 * generating a proxy if needed.
 */
public static vn.cybersoft.obs.andriod.batterystats2.PowerNotifications asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof vn.cybersoft.obs.andriod.batterystats2.PowerNotifications))) {
return ((vn.cybersoft.obs.andriod.batterystats2.PowerNotifications)iin);
}
return new vn.cybersoft.obs.andriod.batterystats2.PowerNotifications.Stub.Proxy(obj);
}
...
private static class Proxy implements vn.cybersoft.obs.andriod.batterystats2.PowerNotifications
{
