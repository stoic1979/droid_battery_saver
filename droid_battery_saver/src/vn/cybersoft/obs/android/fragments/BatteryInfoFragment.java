...
public class BatteryInfoFragment extends Fragment {
	...
	public static final int LAYOUT_ID = R.layout.grid_activity; 
	...
	private TextView mTemperature, mVoltage, mCapacity, mBatteryLevel;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mCapacity.setText(getBatteryCapacity()+ " mAh"); 
	...
	private void drawChart() {
		...
		renderer.setColor(Color.parseColor("#007f9d")); 
  ...
  /*      long value = new Date().getTime() - 3 * TimeChart.DAY;
	...
	private void updateLayout() {
		...
		mVoltage.setText((float)mBatteryInfo.voltage / 1000 + " V");
		...
		//Log.v(t+">>>>>>>>>>>>>>>>>>>>>>>>>>>"+mBatteryInfo.heath);
		//Log.v(t+">>>>>>>>>>>>>>>>>>>>>>>>>>>"+mBatteryInfo.technology);
